...
<body>
    <div id="container">
        ...
        <form id="form1" action="registerServlet" method="post">
            ...
            <p>
                邮&emsp;箱：&emsp;
                <input name="user_mail" type="email" align="left" required="required">
            </p>
            <p>
                姓&emsp;名：&emsp;
            ...
            <p>
                ...
                <input type="submit" value="注册" id="submit1"/>
            </p>
        </form>
        <form id="form2" action="registerServlet" method="post" style="display: none">
